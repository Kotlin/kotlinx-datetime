...
class LocalDateTest {
    ...
    fun atStartOfDay() {
        ...
        assertEquals(parisDate.atTime(0, 0).toInstant(paris, TransitionHandler.REJECT_TRANSITIONS),
...
//                gazaDate.atStartOfDayIn(gaza), "gaza")
        ...
        val fixed = TimeZoneContext.System.get("UTC+14") as FixedOffsetTimeZone
