...
public class DateTimeComponents internal constructor(internal val contents: DateTimeComponentsContents = DateTimeComponentsContents()) {
    ...
    internal fun setDateTimeOffset(instant: kotlinx.datetime.Instant, utcOffset: UtcOffset) {
        setDateTimeOffset(instant.toNewInstant(), utcOffset)
    }
     ...
     */
    public fun toInstantUsingOffset(deprecationMarker: DeprecationMarker = DeprecationMarker.INSTANCE): Instant {
