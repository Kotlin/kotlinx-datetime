...
internal class IncompleteLocalDate(
    ...
    override fun copy(): IncompleteLocalDate =
        IncompleteLocalDate(yearMonth.copy(), dayOfMonth, dayOfWeek, dayOfYear)
    ...
    override fun toString(): String = when {
        dayOfYear == null ->
            "$yearMonth-${dayOfMonth ?: "??"} (day of week is ${dayOfWeek ?: "??"})"
        dayOfMonth == null && monthNumber == null ->
            "(${yearMonth.year ?: "??"})-$dayOfYear (day of week is ${dayOfWeek ?: "??"})"
        else -> "$yearMonth-${dayOfMonth ?: "??"} (day of week is ${dayOfWeek ?: "??"}, day of year is $dayOfYear)"
    }
}
