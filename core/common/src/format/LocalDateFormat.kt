...
internal class IncompleteLocalDate(
    ...
    override fun copy(): IncompleteLocalDate =
        IncompleteLocalDate(yearMonth.copy(), dayOfMonth, isoDayOfWeek, dayOfYear)
    ...
    override fun toString(): String = when {
        dayOfYear == null ->
            "$yearMonth-${dayOfMonth ?: "??"} (day of week is ${isoDayOfWeek ?: "??"})"
        dayOfMonth == null && monthNumber == null ->
            "(${yearMonth.year ?: "??"})-$dayOfYear (day of week is ${isoDayOfWeek ?: "??"})"
        else -> "$yearMonth-${dayOfMonth ?: "??"} (day of week is ${isoDayOfWeek ?: "??"}, day of year is $dayOfYear)"
    }
}
