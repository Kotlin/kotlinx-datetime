...
public expect open class TimeZone {
    ...
    internal fun kotlinx.datetime.Instant.toLocalDateTime(): LocalDateTime
     ...
     */
    public fun LocalDateTime.toInstant(deprecationMarker: DeprecationMarker = DeprecationMarker.INSTANCE): Instant
...
internal fun TimeZone.offsetAt(instant: kotlinx.datetime.Instant): UtcOffset =
    offsetAt(instant.toNewInstant())
...
@PublishedApi
@Suppress("DEPRECATION_ERROR")
internal fun kotlinx.datetime.Instant.toLocalDateTime(timeZone: TimeZone): LocalDateTime =
    toNewInstant().toLocalDateTime(timeZone)
...
@PublishedApi
@Suppress("DEPRECATION_ERROR")
internal fun kotlinx.datetime.Instant.toLocalDateTime(offset: UtcOffset): LocalDateTime =
    toNewInstant().toLocalDateTime(offset)
...
@PublishedApi
@Suppress("DEPRECATION_ERROR")
internal fun kotlinx.datetime.Instant.offsetIn(timeZone: TimeZone): UtcOffset =
    timeZone.offsetAt(toNewInstant())
 ...
 */
public expect fun LocalDateTime.toInstant(timeZone: TimeZone, deprecationMarker: DeprecationMarker = DeprecationMarker.INSTANCE): Instant
 ...
 */
public expect fun LocalDateTime.toInstant(offset: UtcOffset, deprecationMarker: DeprecationMarker = DeprecationMarker.INSTANCE): Instant
 ...
 */
public expect fun LocalDate.atStartOfDayIn(timeZone: TimeZone, deprecationMarker: DeprecationMarker = DeprecationMarker.INSTANCE): Instant
