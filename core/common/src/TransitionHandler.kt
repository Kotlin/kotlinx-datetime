...
public interface TransitionHandler {
     ...
     */
    public object USE_OFFSET_BEFORE : TransitionHandler {
        override fun resolveDateTime(
            dateTime: LocalDateTime,
            transition: LocalDateTimeOffsetInfo.Transition,
            preferredOffset: UtcOffset?
     ...
     */
    public object FIND_EARLIEST_VALID_TIME : TransitionHandler {
        override fun resolveDateTime(
            dateTime: LocalDateTime,
            transition: LocalDateTimeOffsetInfo.Transition,
            preferredOffset: UtcOffset?
     ...
     */
    public object REQUIRE_RESOLVED : TransitionHandler {
        override fun resolveDateTime(
            dateTime: LocalDateTime,
            transition: LocalDateTimeOffsetInfo.Transition,
            preferredOffset: UtcOffset?
     ...
     */
    public object REJECT_TRANSITIONS : TransitionHandler {
        override fun resolveDateTime(
            dateTime: LocalDateTime,
            transition: LocalDateTimeOffsetInfo.Transition,
            preferredOffset: UtcOffset?
