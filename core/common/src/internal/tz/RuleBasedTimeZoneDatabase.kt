...
internal interface RuleBasedTimeZoneDatabase: TimeZoneDatabase {
    ...
    override fun get(id: String): TimeZone = RuleBasedTimeZone(rulesForId(id), id, this)
    override fun getOrNull(id: String): TimeZone? = rulesForIdOrNull(id)?.let { RuleBasedTimeZone(it, id, this) }
}
