...
class CalendarPeriodTest {
    ...
    fun toStringConversion() {
        assertEquals("P1Y", 1.calendarYears.toString())
        assertEquals("P1Y1M", CalendarPeriod(years = 1, months = 1).toString())
        assertEquals("P11M", 11.calendarMonths.toString())
        assertEquals("P14M", 14.calendarMonths.toString()) // TODO: normalize or not
